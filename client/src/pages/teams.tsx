  ...
  return (
    <div className="max-w-lg mx-auto px-4 pt-6 pb-20">
      <div className="flex items-center gap-2 mb-1">
        <IconPlaybook size={28} className="text-navy" />
        <h1 className="font-display text-2xl text-ink" data-testid="text-teams-title">Team Hubs</h1>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="space-y-3">
          {teams?.map((team) => (
            <Card
              key={team.id}
              className="p-4 cursor-pointer transition-all duration-200 hover:shadow-md active:scale-[0.99] rounded-3xl"
